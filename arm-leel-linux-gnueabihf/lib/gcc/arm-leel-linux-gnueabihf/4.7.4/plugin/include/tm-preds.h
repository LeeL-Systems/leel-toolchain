/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/rogerio/bin/leel-toolchain/stage/arm-leel-linux-gnueabihf/.build/src/gcc-linaro-4.7-2014.06/gcc/config/arm/arm.md'.  */

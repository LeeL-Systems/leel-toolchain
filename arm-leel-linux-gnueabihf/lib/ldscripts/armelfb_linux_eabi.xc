...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/rogerio/bin/leel-toolchain/arm-leel-linux-gnueabihf/arm-leel-linux-gnueabihf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
